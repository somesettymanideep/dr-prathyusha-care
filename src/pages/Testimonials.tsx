...
const textTestimonials = [
  {
    ...
    photo: customer1,
    rating: 5,
    text: "Having a great journey with Dr. Prathyusha garu and their staff.",
  ...
  },
  {
    ...
    photo: customer2,
    rating: 5,
    text: "My heartfelt thanks to Dr. Pratyusha garu. I am beyond grateful to the entire team. Very happy with the treatment. And the care and concern from the whole team.",
    treatment: "Fertility Care",
  },
  {
    ...
    photo: customer3,
    rating: 5,
    text: "Dr. Prathyusha mam and hospital staff are very humble.",
  ...
  },
  {
    ...
    photo: customer4,
    rating: 5,
    text: "Having a great journey. And Dr. Prathyusha garu and all staff have maintained responsibility towards our treatment.",
    treatment: "Fertility Care",
  },
  {
    ...
    photo: customer5,
    rating: 5,
    text: "After a lot of struggles finally reached right destination. Thank you so much Prathyusha madam garu and staff members.",
    treatment: "Fertility Care",
  },
  {
    name: "Radha Krishna",
    photo: customer6,
    rating: 5,
    text: "Good treatment and service. Thank you Dr. Prathyusha mam and team.",
    treatment: "Treatment",
  },
];
